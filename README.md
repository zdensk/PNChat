PNChat is a peer-to-peer local network chat application that allows users to discover each other automatically on the local network, exchange messages with low latency.
